  ...
  return (
    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          <img src={logo} alt='logo' className='w-21 h-20 object-contain rounded-full' />
          {/* &nbsp; ---> Empty space tag */}
        ...
        <ul className='list-none hidden sm:flex flex-row gap-10'>
          {/* Navigation options ABOUT / WORK / CONTACT */}
          {/* onClick function sets the section to *Active* and whites it out via styles */}
          {navLinks.map((nav) => (
            <li
              key={nav.id}
              className={`${
